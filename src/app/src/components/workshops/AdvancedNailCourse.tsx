        ...
        >
          ...
          >
            ...
            <p className="text-lg" style={{ color: "#3D3935", opacity: 0.8 }}>
              Our Update Course is designed for nail technicians who already
              have experience and would like to refresh, improve, and update
              their skills using the latest techniques and products in the
              industry.
            </p>
          </div>
          ...
          >
            <div
              ...
              style={{ color: "#3D3935" }}
            >
              Starting from £{workshopDetails.basePrice}
            </div>
