...
export function Navbar() {
  ...
  return (
    ...
    }`} style={{ background: 'linear-gradient(to left, #FCEAE0, #EACAB8)' }}>
      <div className="mx-auto px-4 sm:px-6 lg:px-8 m-[0px]" style={{ maxWidth: '1920px' }}>
          ...
          <DialogFooter className="mt-8 gap-4 sm:justify-center">
            ...
            >
              <span style={{
                ...
                <Phone className="mr-2 h-4 w-4" style={{
              ...
              <svg width="0" height="0" style={{ position: 'absolute' }}>
                <defs>
                  <linearGradient id="whatsapp-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" style={{ stopColor: '#FCEAE0', stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: '#EACAB8', stopOpacity: 1 }} />
                  </linearGradient>
                </defs>
              </svg>
            </Button>
