...
export function ScheduleWorkshopDrawer({
  ...
  const capacityNum = parseCapacity(
    selectedWorkshop?.class_type,
  );
  ...
  const isFull = students.length >= capacityNum;
            ...
            <div className="space-y-5 py-2">
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  >
                    Seats: {students.length} / {capacityNum}
                  </span>
                </div>
                {isFull && (
                  <p
