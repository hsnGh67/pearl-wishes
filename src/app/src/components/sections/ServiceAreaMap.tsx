...
const londonDistricts = [
  ...
  },
  {
    name: "West Finchley",
    enabled: true,
    position: "md:row-start-1 md:col-start-3",
  },
  {
    name: "Mill Hill",
    enabled: true,
  ...
  },
  {
    name: "Golders Green",
    enabled: false,
    position: "md:row-start-2 md:col-start-3",
  },
  {
    name: "Highgate",
    enabled: false,
    position: "md:row-start-1 md:col-start-4",
  },
  {
    name: "Finchley Central",
    enabled: false,
    position: "md:row-start-2 md:col-start-4",
  },
];
...
export function ServiceAreaMap() {
  ...
  const getData = async () => {
    try {
      ...
      setDistricts(res);
      console.log("getAllDistricts ======>", res);
    } catch (e) {}
  };
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We currently serve central London districts. Check
            if your area is covered below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div
              className="text-white p-8 border-2"
              style={{
                backgroundColor: "#3D3935",
                borderColor: "#3D3935",
              }}
            >
              ...
              >
                Don't see your district? Contact us to request
                service expansion in your area. We're actively
                growing our coverage across Greater London.
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 text-justify">
                    Our mobile nail care service currently
                    covers 5 North London districts with 4 more
                    coming soon. We bring professional
                    salon-quality treatments directly to your
                    home, office, or preferred location within
                    these areas.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-justify">
                    Free travel within all covered districts
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div
                  ...
                  ></div>
                  <p className="text-justify">
                    Same-day booking available for select areas
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div
                  ...
                  ></div>
                  <p className="text-justify">
                    We bring all professional equipment and
                    supplies
                  </p>
                </div>
                <div className="flex items-start gap-3">
