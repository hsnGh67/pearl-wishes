...
export function NavbarComparison() {
    ...
    <div style={{ backgroundColor: '#FAF7F5' }}>
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: '24px' }}>
          Choose between these two design variations
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <h2 style={{ fontSize: '42px', fontWeight: 'bold', marginBottom: '15px' }}>
              OPTION A
            </h2>
            <p style={{ fontSize: '22px', marginBottom: '10px' }}>
              Solid Old Rose Background
            </p>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: '18px', opacity: 0.8 }}>
              Peach (#FCEAE0) to Warm Beige (#EACAB8)
            </p>
          </div>
          
          {/* Actual Navbar Variation 2 */}
      ...
      {/* Bottom spacing */}
      <div style={{ height: '100px', backgroundColor: '#FAF7F5' }} />
