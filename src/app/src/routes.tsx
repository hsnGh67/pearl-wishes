    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "promo-codes", element: <AdminPromoCodes /> },
          {
            ...
            element: <AdminPromoCodeCreate />,
          },
          {
            path: "promo-codes/:id",
            element: <AdminPromoCodeDetails />,
          },
          {
